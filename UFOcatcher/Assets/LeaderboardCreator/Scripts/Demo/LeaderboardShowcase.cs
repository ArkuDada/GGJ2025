...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        {
            Leaderboards.DITGameJam2025Leaderboard.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.DITGameJam2025Leaderboard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
